#!/usr/bin/env bash
# Bi-Res + original DetGeo PE + Acc@0.25/0.50 threshold-aware regression.
set -euo pipefail
cd "$(dirname "$0")/.."

PYTHON_BIN="${PYTHON_BIN:-/root/miniconda3/envs/detgeo/bin/python}"
NAME="trogeo_ms_e4_amhcsfi_res_bi_detgeope_thrreg_naturalrng_swin_t_drone_seed2024"
COMMON=(
...
PYTHONPATH=. "$PYTHON_BIN" tools/test_e4_threshold_reg.py
