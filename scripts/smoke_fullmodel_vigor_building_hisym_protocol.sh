...
NAME="trogeo_ms_vigor_building_full_hisym_crgpe_swin_t_seed13_smoke"

PYTHONPATH=. "$PYTHON_BIN" tools/test_vigor_dynamic_grid.py
PYTHONPATH=. "$PYTHON_BIN" train.py \
  --gpu 0 --num_workers 4 --batch_size 12 --emb_size 768 --img_size 640 \
  ...
  --beta 1.0 --coarse_loss_weight 0.2 --coarse_sigma 1.5 --fine_sigma 3.0 \
  --print_freq 200 --max_epoch 1 --savename "$NAME"
