...
for FOLD in 1 2 3 4 5; do
  NAME="fullmodel_swin_t_groupcv5_drone_f${FOLD}_seed2024"
  ...
  PYTHONPATH=. "$PYTHON_BIN" train.py \
    ...
    --train_pth "data/CVOGL_DroneAerial/cv5_grouped/fold${FOLD}_train.pth" \
    --val_pth "data/CVOGL_DroneAerial/cv5_grouped/fold${FOLD}_val.pth" \
    ...
    --gaussian_sigma 25 --crgpe_outer_sigma 50 --dadpe_mode none --amr_pe_mode none \
