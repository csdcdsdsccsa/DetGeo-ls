...
run_one_epoch() {
  ...
  PYTHONPATH=. "$PYTHON_BIN" train.py --gpu 0 --num_workers 24 --batch_size 7 --emb_size 768 --img_size 1024 \
...
CUDA_VISIBLE_DEVICES="$GPU" run_one_epoch CVOGL_DroneAerial fullmodel_swin_t_groupcv5_smoke_drone_seed2024 '--gaussian_sigma 25 --crgpe_outer_sigma 50'
CUDA_VISIBLE_DEVICES="$GPU" run_one_epoch CVOGL_SVI fullmodel_swin_t_groupcv5_smoke_svi_seed2024 '--gaussian_sigma 25 --gaussian_sigma_x 50 --crgpe_outer_sigma 50 --crgpe_outer_sigma_x 100'
