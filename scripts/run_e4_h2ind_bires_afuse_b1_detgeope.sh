...
NAME="trogeo_ms_e4_bires_afuse_b1_detgeope_naturalrng_swin_t_drone_seed2024"
COMMON=(--gpu 0 --num_workers 24 --batch_size 7 --emb_size 768 --img_size 1024
  ...
  --trogeo_ms_det_variant h2_ind_bires_afuse_b1
...
PYTHONPATH=. "$PYTHON_BIN" tools/test_e4_bires_afuse_b1.py
