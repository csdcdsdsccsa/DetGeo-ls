#!/usr/bin/env bash
# Bi-Res + DetGeo PE QCC-AF: CxQ competition plus agreement-aware box fusion.
# The ranker remains instantiated for matched layout but is never consumed.
set -euo pipefail
cd "$(dirname "$0")/.."
PYTHON_BIN="${PYTHON_BIN:-/root/miniconda3/envs/detgeo/bin/python}"
NAME="trogeo_ms_e4_amhcsfi_res_bi_detgeope_qcc_af_naturalrng_swin_t_drone_seed2024"
