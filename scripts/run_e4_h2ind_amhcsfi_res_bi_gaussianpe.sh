#!/usr/bin/env bash
# Bi-Res + DetGeo position encoder with only its click-map channel changed.
set -euo pipefail
cd "$(dirname "$0")/.."

PYTHON_BIN="${PYTHON_BIN:-/root/miniconda3/envs/detgeo/bin/python}"
NAME="trogeo_ms_e4_amhcsfi_res_bi_gaussianpe_sigma25_naturalrng_swin_t_drone_seed2024"
COMMON=(
  ...
  --trogeo_position_mode detgeo --trogeo_click_map_mode gaussian --gaussian_sigma 25
  --dadpe_mode none --standard_rng --seed 2024 --beta 1.0 --print_freq 50
