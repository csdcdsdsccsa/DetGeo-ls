#!/usr/bin/env bash
# Bi-Res + DetGeo-PE output ablation: raw concat of Stage-3 and aligned Stage-4.
set -euo pipefail
cd "$(dirname "$0")/.."

PYTHON_BIN="${PYTHON_BIN:-/root/miniconda3/envs/detgeo/bin/python}"
NAME="trogeo_ms_e4_amhcsfi_res_bi_concat_detgeope_naturalrng_swin_t_drone_seed2024"
COMMON=(
  ...
  --trogeo_ms_det_variant h2_ind_amhcsfi_res_bi_concat
...
PYTHONPATH=. "$PYTHON_BIN" tools/test_e4_bires_output_ablation.py
