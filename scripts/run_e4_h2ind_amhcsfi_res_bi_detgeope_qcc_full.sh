#!/usr/bin/env bash
# Bi-Res + DetGeo PE QCC-Full: QCC-B plus predicted-box agreement fusion.
set -euo pipefail
cd "$(dirname "$0")/.."
PYTHON_BIN="${PYTHON_BIN:-/root/miniconda3/envs/detgeo/bin/python}"
NAME="trogeo_ms_e4_amhcsfi_res_bi_detgeope_qcc_full_naturalrng_swin_t_drone_seed2024"
COMMON=(--gpu 0 --num_workers 24 --batch_size 7 --emb_size 768 --img_size 1024
  ...
  --trogeo_ms_det_variant h2_ind_amhcsfi_res_bi_qcc_full
...
PYTHONPATH=. "$PYTHON_BIN" tools/test_e4_qcc.py --gpu_variant h2_ind_amhcsfi_res_bi_qcc_full
