#!/usr/bin/env bash
# Bi-Res + DetGeo-PE output ablation: raw concat without AMHCSFI-Res.
set -euo pipefail
cd "$(dirname "$0")/.."

PYTHON_BIN="${PYTHON_BIN:-/root/miniconda3/envs/detgeo/bin/python}"
NAME="trogeo_ms_e4_bi_nocsfi_concat_detgeope_naturalrng_swin_t_drone_seed2024"
COMMON=(
  ...
  --trogeo_ms_det_variant h2_ind_bi_nocsfi_concat
